...
- semantic `insert-text`, `insert-paragraph-break`, `delete-backward`, and
  ...
  pending formats and atomically replaces cross-paragraph selections, while
  `toggle-strong` publishes tracked
...
direct-root base-paragraph text structure, semantic cross-paragraph deletion,

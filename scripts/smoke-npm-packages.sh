...
readonly browser_tarball="${tarball_directory}/breditor-browser-0.3.0-alpha.11.tgz"
readonly reference_tarball="${tarball_directory}/breditor-reference-highlight-0.3.0-alpha.11.tgz"
readonly wasm_tarball="${tarball_directory}/breditor-wasm-0.3.0-alpha.11.tgz"
...
assert_archive_size "@breditor/browser" "${browser_tarball}" 260000
assert_archive_size "@breditor/reference-highlight" "${reference_tarball}" 22000
...
assert_archive_member_sha256 "${wasm_tarball}" \
  ...
  9244960a49b7306ed7d84848e74c0e6a4e94c40c6f19110ff26ba4f130f37cfd
assert_archive_member_sha256 "${wasm_tarball}" \

...
`0.2.0` extension surface, and the `0.3.0-alpha.17` source checkpoint.
...
The unpublished `0.3.0-alpha.17` source package changes no browser or Wasm
...
```sh
npm install @breditor/browser@0.3.0-alpha.17 @breditor/wasm@0.3.0-alpha.17
```

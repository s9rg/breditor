...
dependency (`0.2.127`) and Node.js for the generated-glue adversarial probe. It
never downloads or installs tools. If either executable is not on `PATH`,
...
cases that Rust-side Wasm tests cannot reach.

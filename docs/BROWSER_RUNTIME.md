...
the unpublished `0.3.0-alpha.18` ABI-5 typed-profile, typed-intent, explicit
...
exactly matching `0.3.0-alpha.18` packages:

```sh
npm install @breditor/browser@0.3.0-alpha.18 \
  @breditor/wasm@0.3.0-alpha.18 \
  @breditor/reference-highlight@0.3.0-alpha.18
```

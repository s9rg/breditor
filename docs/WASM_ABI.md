...
Status: `0.2.0-alpha.2` packaged boundary contract; ABI generation `2` is authoritative
...
`@breditor/browser@0.2.0-alpha.2` and `@breditor/wasm@0.2.0-alpha.2` are supported as an

...
use super::{LocalLogEntryV3CodecError, LocalLogFrameErrorCode};

/// Why one Local Log Frame V3 operation was rejected.
#[non_exhaustive]
#[derive(Debug, Error)]
pub enum LocalLogFrameV3CodecError {
    ...
    /// The Local Log Entry V3 semantic codec rejected the payload.
    #[error("invalid local-log frame V3 entry: {0}")]
    InvalidEntry(#[source] Box<LocalLogEntryV3CodecError>),
...
impl LocalLogFrameV3CodecError {

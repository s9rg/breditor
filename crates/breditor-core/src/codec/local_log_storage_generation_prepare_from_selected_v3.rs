use super::{
    ...
    LocalLogStorageGenerationPreparationInputs, LocalLogStorageGenerationV3CodecError,
    LocalLogStorageSelectedRootV3, LocalLogTailCompactionOutcomeV3,
    local_log_storage_generation_json_v3::validate_binding_field,
    local_log_storage_generation_prepare_v3::build_manifest,
};

impl LocalLogStorageGenerationJsonCodecV3 {
    /// Builds one V3 rotation from a normalized selected V3 root.
    ///
    /// Failure is non-destructive and no candidate is promoted or published.
    ///
    /// # Errors
    ///
    /// Returns [`LocalLogStorageGenerationV3CodecError`] for selected-edge,
